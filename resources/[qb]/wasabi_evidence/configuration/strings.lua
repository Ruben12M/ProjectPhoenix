...
Strings = {
    ...
    add_prints = 'Add To Database',
    add_prints_desc = 'Add suspect prints to the manual print database',
    invalid_print_data = 'Invalid Fingerprint Data',
    invalid_print_data_desc = 'Please enter both a first and last name',
    prints_recorded = 'Print Record Recorded',
    prints_recorded_desc = 'Print record recorded in the database successfully',
    manual_print = 'Manual Print Record',
    manual_print_prefix = 'Name: ',
    fingerprint_data_record = 'Fingerprint Data Record',
