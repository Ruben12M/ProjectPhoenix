...
Config.AdvancedParking = false -- Delete vehicles with threir exports
Config.Jail = {
...
Config.inventory = 'qs' -- NEEDED FOR SEARCHING PLAYERS - Current options: 'ox' (For ox_inventory) / 'qb' (For QbCore Inventory) / 'mf' (For mf inventory) / 'qs' (For qs_inventory) / 'cheeza' (For cheeza_inventory) / 'custom' (Custom can be added in client/cl_customize.lua)
...
Config.GPSBlips = {
    enabled = true, -- Enabled?
    refreshrate = 3 * seconds, -- Refreshrate
    dead = true, -- Show also dead players?
    item = false, -- Item required
    blip = {
        sprite = 1,
        color = 29,
        scale = 1.0,
        string = '%s' -- %s = Playername
    }
}
...
Config.Locations = {
    LSPD = {
        ...
        armoury = {
            ...
            ped = 's_f_y_cop_01',
            label = '[E] - Armeiro', -- String of text ui
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
        ...
        cloakroom = {
            ...
            label = '[E] - Fardas', -- String of text ui of cloakroom
