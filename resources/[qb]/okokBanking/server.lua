...
local Webhook = 'https://discordapp.com/api/webhooks/1115406606054723715/wbnSdO269YBCETSnXTapwYIGHziqQb_jnPC4vjzIhMu_phbr6dFQGJIFDipXVQ4g22Wy'
...
AddEventHandler("okokBanking:UpdatePINDB", function(pin, amount)
	...
	if amount <= xPlayer.PlayerData.money.bank then
		...
		if Config.okokNotify then
			...
			TriggerClientEvent('QBCore:Notify', _source, Lang:t("pin_changed", {s1 = pin}), _L('pin_changed').type)
		end
	else
		if Config.okokNotify then
