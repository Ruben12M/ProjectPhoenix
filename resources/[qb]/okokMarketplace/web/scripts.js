...
window.addEventListener('message', function(event) {
	...
	switch (event.data.action) {
		case 'openVehicleMarket':
			...
			$('#top-search').html(`
				<div class="input-group" style="margin-right: 10px;">
					<input type="search" id="searchbox" class="form-control searchbox" placeholder="Pesquisar..." style="margin-right: 1px;">
					<button type="button" id="searchbtn" class="btn btn-blue searchbtn"><i class="fas fa-search"></i></button>
				</div>
				<div class="btn-group" style="margin-right: 10px;">
                    <button type="button" class="btn btn-blue dropdown-toggle sortbtn" data-bs-toggle="dropdown" aria-expanded="false">Filtrar por</button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item selected" id="newest">Novo para antigo</a></li>
                        <li><a class="dropdown-item" id="lowest">Preço mais baixo</a></li>
                        <li><a class="dropdown-item" id="highest">Preço mais alto</a></li>
                    </ul>
                </div>
				<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
				<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalVehicles"><i class="fas fa-plus"></i> Colocar um anúncio</button>
			`);

			if(accessBlackmarket) {
				$('#sidebar').html(`
					<p class="sidebar-item mt-2 selected" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Veículos</span></p>
					<p class="sidebar-item" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Items</span></p>
					<p class="sidebar-item" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Mercado Ilegal</span></p>
				`);

				$('#sidebar-personal').html(`
					<p class="sidebar-item mt-2 position-relative" id="myads_page" style="margin-bottom: 12px;">
						<i class="fas fa-bullhorn"></i> <span class="ms-1">Meus Ads</span>
			...
			var dropdown = `<option value="0" selected>Seleciona um veículo</option>`;
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Vendedor:</b> ${vehiclesAds[i].author_name}</div><div><b>Telefone:</b> ${vehiclesAds[i].phone_number}</div><div><b>Descrição:</b> ${vehiclesAds[i].description}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
										...
										<div class="modal-content myinvoices_modal-content">
											<div class="modal-body p-4">
												<div class="text-center">
													<span style="font-weight: 600; font-size: 40px; text-align: center;">Tens a certeza?</span>
												</div>
												<hr>
			...
			if(added == 0) {
				row = `<div class="d-flex justify-content-center align-items-center h-100 flex-column">
							<div class="d-flex justify-content-center">
								<span class="text-center" id="info-text">Não existem anúncios disponiveis</span>
							</div>
							<div>
		...
		case 'updateItemsDropdown':
			...
			var dropdown = `<option value="0" selected>Seleciona um item</option>`;
		...
		case 'updateVehicles':
			...
			if(accessBlackmarket) {
				...
				<p class="sidebar-item mt-2 selected" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Veículos</span></p>
				<p class="sidebar-item" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Items</span></p>
				<p class="sidebar-item" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Mercado Ilgeal</span></p>
			`);
		...
		case 'updateItems':
			...
			if(accessBlackmarket) {
				$('#sidebar').html(`
					<p class="sidebar-item mt-2" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Veículos</span></p>
					<p class="sidebar-item selected" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Items</span></p>
					<p class="sidebar-item" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Mercado Negro</span></p>
				`);

				$('#sidebar-personal').html(`
					<p class="sidebar-item mt-2 position-relative" id="myads_page" style="margin-bottom: 12px;">
						<i class="fas fa-bullhorn"></i> <span class="ms-1">Meus anúncios</span>
						<span class="badge bg-danger">${myAds.length}</span>
					</p>
				`);
			} else {
			...
			for(var i = 0; i < num2; i++) {
				...
				row += `
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Vendedor:</b> ${itemsAds[i].author_name}</div><div><b>Telefone:</b> ${itemsAds[i].phone_number}</div><div><b>Descrição:</b> ${itemsAds[i].description}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
		...
		case 'updateBlackmarket':
			...
			if(accessBlackmarket) {
				$('#sidebar').html(`
					<p class="sidebar-item mt-2" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Veículos</span></p>
					<p class="sidebar-item" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Items</span></p>
					<p class="sidebar-item selected" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Mercado Negro</span></p>
				`);
			...
			for(var i = 0; i < num2; i++) {
				...
				row += `
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Vendedor:</b> ${blackmarketAds[i].author_name}</div><div><b>Telefone:</b> ${blackmarketAds[i].phone_number}</div><div><b>Descrição:</b> ${blackmarketAds[i].description}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
		...
		case 'updateMyAds':
						...
						row += `
							<div class="col-md-3">
								<div class="card item_card">
									<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
										<span class="infohover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<div><b>Vendedor:</b> ${myAds[i].author_name}</div><div><b>Telefone:</b> ${myAds[i].phone_number}</div><div><b>Descrição:</b> ${myAds[i].description}</div>" data-bs-trigger="hover"><i class="fas fa-info-circle"></i></span>
						...
						row += `
							<div class="col-md-3">
								<div class="card item_card">
									...
									<a id="claimAd" href="#" class="btn btn-green d-block item_card-btn" data-bs-toggle="modal" data-bs-target="#${modal_id}"><i class="fas fa-hand-holding-usd"></i> RESGATAR</a>
								</div>
							</div>
						`;
					} else {
			...
			if(added == 0) {
				row = `<div class="d-flex justify-content-center align-items-center h-100 flex-column">
							<div class="d-flex justify-content-center">
								<span class="text-center" id="info-text">Não possuis nenhum anúncio no mercado</span>
							</div>
						</div>`;
			}
...
$(document).on('click', "#newest", function() {
	if (selectedWindow == "vehicles") {
		...
		$('#top-search').html(`
			<div class="input-group" style="margin-right: 10px;">
				<input type="search" id="searchbox" class="form-control searchbox" placeholder="A pesquisar..." style="margin-right: 1px;">
				<button type="button" id="searchbtn" class="btn btn-blue searchbtn"><i class="fas fa-search"></i></button>
			</div>
			<div class="btn-group" style="margin-right: 10px;">
	            <button type="button" class="btn btn-blue dropdown-toggle sortbtn" data-bs-toggle="dropdown" aria-expanded="false">Filtrar por</button>
			...
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalVehicles"><i class="fas fa-plus"></i> Coloca um anúncio</button>
		`);
	} else if (selectedWindow == "items") {
		...
		$('#top-search').html(`
			...
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalItems"><i class="fas fa-plus"></i> Coloca um anúncio</button>
		`);
	} else if (selectedWindow == "blackmarket") {
		...
		$('#top-search').html(`
			...
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalBlackmarket"><i class="fas fa-plus"></i> Coloca um anúncio</button>
		`);
	}
});
	...
	if (selectedWindow == "vehicles") {
		...
		$('#top-search').html(`
			...
			<div class="btn-group" style="margin-right: 10px;">
	            <button type="button" class="btn btn-blue dropdown-toggle sortbtn" data-bs-toggle="dropdown" aria-expanded="false">Filtrar por</button>
	            <ul class="dropdown-menu">
	                <li><a class="dropdown-item" id="newest">Novo para antigo</a></li>
	                <li><a class="dropdown-item selected" id="lowest">Preço mais baixo</a></li>
	                <li><a class="dropdown-item" id="highest">Preço mais alto</a></li>
	            </ul>
	        </div>
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
		...
		$('#top-search').html(`
			...
			<div class="btn-group" style="margin-right: 10px;">
	            ...
	            <ul class="dropdown-menu">
	                <li><a class="dropdown-item" id="newest">Novo para antigo</a></li>
	                <li><a class="dropdown-item" id="lowest">Preço mais baixo</a></li>
	                <li><a class="dropdown-item selected" id="highest">Preço mais alto</a></li>
	            </ul>
	        </div>
			<button type="button" id="refreshbtn" class="btn btn-blue"><i class="fas fa-sync-alt"></i></button>
			<button type="button" id="placeAd" class="btn btn-blue adbtn" data-bs-toggle="modal" data-bs-target="#placeAdModalVehicles"><i class="fas fa-plus"></i> Coloca um anúncio</button>
  ...
  selectedWindow = "myads";
	...
	if(accessBlackmarket) {
		$('#sidebar').html(`
			<p class="sidebar-item mt-2" id="vehicles_page" style="margin-bottom: 12px;"><i class="fas fa-car"></i> <span class="ms-1">Veículos</span></p>
			<p class="sidebar-item" id="items_page" style="margin-bottom: 12px;"><i class="fas fa-box"></i> <span class="ms-1">Items</span></p>
			<p class="sidebar-item" id="blackmarket_page" style="margin-bottom: 12px;"><i class="fas fa-user-ninja"></i> <span class="ms-1">Mercador Negro</span></p>
		`);
	...
	if(added == 0) {
		row = `<div class="d-flex justify-content-center align-items-center h-100 flex-column">
					<div class="d-flex justify-content-center">
						<span class="text-center" id="info-text">Não tens nenhum anúncio no mercado</span>
					</div>
				</div>`;
	}
	...
	if (search != "") {
		if (selectedWindow == "vehicles") {
			...
			if(added == 0) {
				row = `<div class="d-flex justify-content-center align-items-center h-100 flex-column">
							<div class="d-flex justify-content-center">
								<span class="text-center" id="info-text">Não há anúncios correspondentes '${search}'</span>
							</div>
						</div>`;
			}
