			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				if toItemData then
					...
					if toItemData.name ~= fromItemData.name then
						...
						exports['qs-inventory']:SendWebhook(Webhooks.swap, "Swapped Item", 7393279, "**".. GetPlayerName(src) .. "**(id: "..src..") swapped item; name: **"..toItemData.name.."**, amount: **" .. toAmount .. "** with name: **" .. fromItemData.name .. "**, amount: **" .. fromAmount.. "**")
					end
				end
