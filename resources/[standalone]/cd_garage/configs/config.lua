...
Config.VehicleKeys = {
    ...
    Lockpick = {
        ...
        command = 'lockpick', --Customise the chat command.
    },
}
...
Config.JobVehicles = {
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `6x6psp`},
            [2] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `caddyilcbm`},
            [3] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `camaro`},
            [4] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `benson`},
            [5] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `sheriff2`},
            [6] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `psp_i8`},
            [7] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `i40`},
            [8] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `ktmpsp`},
            [9] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `cprotection`},
            [10] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `m8comando`},
            [11] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `WRr1200`},
            [12] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `lpd_wegasharan`},
            [13] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `14tesla`},
            [14] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `fordpc`},
            [15] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'car', model = `sheriffx6`},

            [16] = {job = 'police', spawn_max = true, plate = 'PSP', job_grade = 0, garage_type = 'air', model = `as350`},

            [17] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'boat', model = `predator`},
        },
        ['ambulance'] = {
            [1] = {job = 'ambulance', spawn_max = true, plate = 'INEM', job_grade = 0, garage_type = 'car', model = `ambulancei`},
            [2] = {job = 'ambulance', spawn_max = true, plate = 'INEM', job_grade = 0, garage_type = 'car', model = `anpc_l200`},
            [3] = {job = 'ambulance', spawn_max = true, plate = 'INEM', job_grade = 0, garage_type = 'car', model = `anpc_l200+hi`},
            [4] = {job = 'ambulance', spawn_max = true, plate = 'INEM', job_grade = 0, garage_type = 'car', model = `ems_gs1200`},
            [5] = {job = 'ambulance', spawn_max = true, plate = 'INEM', job_grade = 0, garage_type = 'car', model = `pt_inem4`},
            [6] = {job = 'ambulance', spawn_max = true, plate = 'INEM', job_grade = 0, garage_type = 'air', model = `heli1inem`},
        },
    }
}
